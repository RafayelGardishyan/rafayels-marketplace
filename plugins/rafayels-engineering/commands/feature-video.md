...
rclone copy tmp/videos/ r2:rafayel-claude/pr-videos/pr-[number]/ --s3-no-check-bucket --progress
rclone copy tmp/screenshots/ r2:rafayel-claude/pr-videos/pr-[number]/screenshots/ --s3-no-check-bucket --progress

# List uploaded files
rclone ls r2:rafayel-claude/pr-videos/pr-[number]/
```

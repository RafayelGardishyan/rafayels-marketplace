...
**For Hybrid Projects (e.g., Go API + SvelteKit Frontend):**
```markdown
...
2. Navigate to each page and capture snapshots (using Pi browser tools, Playwright MCP, or agent-browser CLI depending on harness)

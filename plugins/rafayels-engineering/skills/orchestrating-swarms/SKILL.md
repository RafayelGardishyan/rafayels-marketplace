...
// Go code review
Task({
  subagent_type: "compound-engineering:review:rafayel-go-reviewer",
...
- `chi-reviewer` - Chi router/Go HTTP style
- `julik-frontend-races-reviewer` - JavaScript race conditions
- `rafayel-python-reviewer` - Python best practices
- `rafayel-go-reviewer` - Go best practices
- `rafayel-typescript-reviewer` - TypeScript best practices
- `rafayel-sveltekit-reviewer` - SvelteKit best practices
